...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://BotUser:BotUserPassword@cluster0.s2q0pk9.mongodb.net/vj_bot_db?retryWrites=true&w=majority") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
